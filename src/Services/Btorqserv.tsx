...
const services: Service[] = [
  ...
  img: serv7,
  desc: "Design, installation, and deployment of welding habitats for safe hot-work in hazardous zones.",
  client: "EATECH/MPNU",
  date: "2024",
},
{
  ...
  img: serv7,
  desc: "Provision of habitat systems and isolation barriers to support pipeline maintenance operations.",
  client: "CHEVRON",
  date: "2024",
},
{
  ...
  img: serv7,
  desc: "Setup of controlled-environment habitats enabling safe hot-bolting and hot-work activities in live production areas.",
...
},
{
  ...
  img: serv7,
  desc: "Atmospheric monitoring, gas detection, and safety management for all habitat-supported works.",
  client: "SHELL",
  date: "2024",
},
{
  ...
  img: serv7,
  desc: "Deployment of specialized habitat enclosures to support chemical cleaning and sensitive plant operations.",
  client: "NLNG",
  date: "2023",
},
{
  ...
  img: serv7,
  desc: "Fabrication, mobilization, and installation of custom-designed habitat structures for complex maintenance tasks.",
  client: "AGIP",
  date: "2024",
},
